export function Sidebar({ data, selectedChannel, handleChannelSearch }) {
  ...
  return (
    <div className='absolute top-0 left-0 m-4 flex flex-col w-80 gap-4 dark:text-white'>
...
function RelatedChannels({ relatedChannels }) {
  ...
  return (
    <div className='w-full border-3 p-2 border-gray-300 bg-white dark:bg-gray-600'>
